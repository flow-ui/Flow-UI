...
(function(seajs){
    var mod = {
        'audio/audio'                       : '1.0.1',
        'copy/ZeroClipboard'                : '0.0.1',
        'flv/flv'                           : '0.0.2',
        'jquery/1/jquery'                   : '1.11.3',
        'jquery/2/jquery'                   : '2.1.4',
        'jquery/3/jquery'                   : '3.1.1',
        'raty/raty'                         : '0.1.0',
        'upload/upload'                     : '1.1.1',
        'upload/makethumb'                  : '0.0.1',
        'upload/localResizeIMG'             : '0.0.1',
        'validform/validform'               : '2.4.6',
        'video/video'                       : '0.0.1',
        'webuploader/webuploader'           : '1.0.0',
        'zTree/zTree'                       : '0.0.1',
        'album'                             : '2.2.13',
        'appcan'                            : '0.1.0',
        'autocomplete'                      : '0.1.0',
