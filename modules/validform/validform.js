...
define('validform', function(require, exports, module) {
	...
	seajs.importStyle('.Validform_right{color:#71b83d}.Validform_wrong{color:red;white-space:nowrap}\
		...
		.passwordStrength b{font-weight:normal}.passwordStrength b,.passwordStrength span{display:inline-block;vertical-align:middle;line-height:16px;height:16px}\
		.passwordStrength span{width:63px;text-align:center;background-color:#d0d0d0;border-right:1px solid #fff}\
		.passwordStrength .last{border-right:0;width:61px}.passwordStrength .bgStrength{color:#fff;background-color:#71b83d}'
		,module.uri);
