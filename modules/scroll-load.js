...
define('scroll-load', function(require, exports, module) {
    "use strict";
    seajs.importStyle('.scrollLoadSpinning{text-align: center;background:#fff;border-top:1px solid #ccc;padding:.5em;}\
    ...
    $.fn.scrollLoad = function(callback,force){
        var $wrap = $(this), 
            scrollDom, viewH, contHeight, scrollCB, running, $loading,
            safeDistance = 70;
        if($wrap.is('body')){
            scrollDom = $(window);
            contHeight = function(){
        ...
        if(!force){
            if(callback===false || window.nomore){
